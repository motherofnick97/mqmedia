...
@Component({
    templateUrl: './add-contract-kol-dialog.component.html',
    standalone: true,
    imports: [
        FormsModule,
...
export class AddContractKolDialogComponent extends AppComponentBase implements OnInit {
