...
export class ContractTemplateDto implements IContractTemplateDto {
    ...
    constructor(data?: IContractTemplateDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ContractTemplateDto {
        data = typeof data === 'object' ? data : {};
        let result = new ContractTemplateDto();
        result.init(data);
        return result;
    }
...
export interface IContractTemplateDtoPagedResultDto {
    totalCount: number;
    items: ContractTemplateDto[] | undefined;
}

export class ContractTemplateDtoPagedResultDto implements IContractTemplateDtoPagedResultDto {
    totalCount: number;
    items: ContractTemplateDto[] | undefined;

    constructor(data?: IContractTemplateDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items!.push(ContractTemplateDto.fromJS(item));
            }
        }
    }

    static fromJS(data: any): ContractTemplateDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new ContractTemplateDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): ContractTemplateDtoPagedResultDto {
        const json = this.toJSON();
        let result = new ContractTemplateDtoPagedResultDto();
        result.init(json);
        return result;
...
export class ContractTemplateServiceProxy {
    ...
    getAll(keyword: string | undefined, sorting: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<ContractTemplateDtoPagedResultDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_: any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try { return this.processGetAll(response_ as any); }
                catch (e) { return _observableThrow(e) as any as Observable<ContractTemplateDtoPagedResultDto>; }
            } else return _observableThrow(response_) as any as Observable<ContractTemplateDtoPagedResultDto>;
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<ContractTemplateDtoPagedResultDto> {
        const status = response.status;
        const responseBlob = response instanceof HttpResponse ? response.body : (response as any).error instanceof Blob ? (response as any).error : undefined;
        let _headers: any = {}; if (response.headers) { for (let key of response.headers.keys()) { _headers[key] = response.headers.get(key); } }
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
                let result200: any = null;
                let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
                result200 = ContractTemplateDtoPagedResultDto.fromJS(resultData200);
                return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
    ...
    get(id: string | undefined): Observable<ContractTemplateDto> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_: any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try { return this.processGet(response_ as any); }
                catch (e) { return _observableThrow(e) as any as Observable<ContractTemplateDto>; }
            } else return _observableThrow(response_) as any as Observable<ContractTemplateDto>;
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<ContractTemplateDto> {
        const status = response.status;
        const responseBlob = response instanceof HttpResponse ? response.body : (response as any).error instanceof Blob ? (response as any).error : undefined;
        let _headers: any = {}; if (response.headers) { for (let key of response.headers.keys()) { _headers[key] = response.headers.get(key); } }
        if (status === 200) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
                let result200: any = null;
                let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
                result200 = ContractTemplateDto.fromJS(resultData200);
                return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
    ...
    create(body: CreateContractTemplateDto | undefined): Observable<ContractTemplateDto> {
    ...
    protected processCreate(response: HttpResponseBase): Observable<ContractTemplateDto> {
        const status = response.status;
        const responseBlob = response instanceof HttpResponse ? response.body : (response as any).error instanceof Blob ? (response as any).error : undefined;
        let _headers: any = {}; if (response.headers) { for (let key of response.headers.keys()) { _headers[key] = response.headers.get(key); } }
        if (status === 200) {
    ...
    update(body: ContractTemplateDto | undefined): Observable<ContractTemplateDto> {
    ...
    protected processUpdate(response: HttpResponseBase): Observable<ContractTemplateDto> {
        const status = response.status;
        const responseBlob = response instanceof HttpResponse ? response.body : (response as any).error instanceof Blob ? (response as any).error : undefined;
        let _headers: any = {}; if (response.headers) { for (let key of response.headers.keys()) { _headers[key] = response.headers.get(key); } }
        if (status === 200) {
