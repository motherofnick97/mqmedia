...
namespace MqSocial.Migrations
{
    ...
    [Migration("20260825132500_Rename_BriefLink_To_DemoLink")]
    partial class Rename_BriefLink_To_DemoLink
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MqSocial.Careers.Career", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MqSocial.ContractKolReviews.ContractKolReview", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MqSocial.ContractTemplates.ContractTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MqSocial.KolCareers.KolCarrer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("KolCareers");
                });

            modelBuilder.Entity("MqSocial.KolDuplicateContracts.KolDuplicateContract", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("FirstContractId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("SecondContractId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("KolDuplicateContracts");
                });

            modelBuilder.Entity("MqSocial.KolGenerals.KolGeneral", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("MqSocial.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("MqSocial.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("MqSocial.KolCareers.KolCarrer", b =>
                {
                    b.HasOne("MqSocial.Careers.Career", "Career")
                        .WithMany()
            ...
            modelBuilder.Entity("MqSocial.Kols.Kol", b =>
                {
                    b.HasOne("MqSocial.KolGenerals.KolGeneral", "KolGeneral")
                        .WithMany()
                        .HasForeignKey("KolGeneralId");

                    b.Navigation("KolGeneral");
                });
