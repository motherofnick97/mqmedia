...
public abstract class MqSocialWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
{
    protected static readonly Lazy<string> ContentRootFolder;

    static MqSocialWebTestBase()
    {
    ...
    protected override IWebHostBuilder CreateWebHostBuilder()
    {
        return base
            ...
            .UseSetting(WebHostDefaults.ApplicationKey, typeof(MqSocialWebMvcModule).Assembly.FullName);
    }
    ...
    {
        using (var context = IocManager.Resolve<MqSocialDbContext>())
        {
            action(context);
            context.SaveChanges();
        }
    ...
    protected async Task UsingDbContextAsync(Func<MqSocialDbContext, Task> action)
    {
        using (var context = IocManager.Resolve<MqSocialDbContext>())
        {
    ...
    protected async Task<T> UsingDbContextAsync<T>(Func<MqSocialDbContext, Task<T>> func)
    {
        T result;
